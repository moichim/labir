...
&lt;thermal-file-app url=&quot;${this.file.url}&quot;&gt;&lt;/thermal-file-app&gt;
    ...
    `;ll([_e({context:Fn,subscribe:!0})],ts.prototype,"markers",2);ts=ll([ue("file-marks-content")],ts);var nf=Object.defineProperty,af=Object.getOwnPropertyDescriptor,Hn=(r,e,t,i)=>{for(var s=i>1?void 0:i?af(e,t):e,n=r.length-1,a;n>=0;n--)(a=r[n])&&(s=(i?a(e,t,s):a(s))||s);return i&&s&&nf(e,t,s),s};let rs=class extends Ze{constructor(){super(...arguments),this.graphWidth=0,this.container=je(),this.graphs={values:[[]],colors:[]}}onInstanceCreated(r){r.analysisData.addListener(this.UUID,e=>{this.graphs=e}),this.graphs=r.analysisData.value,this.container.value&&(this.graphWidth=this.container.value.clientWidth,new ResizeObserver(t=>{console.log(t),this.graphWidth=t[0].contentRect.width}).observe(this.container.value))}onFailure(r){}render(){return A`
