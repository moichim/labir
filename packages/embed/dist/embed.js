 ...
 */const me=r=>r??j;var Vm=Object.defineProperty,Ym=Object.getOwnPropertyDescriptor,Vs=(r,e,t,i)=>{for(var s=i>1?void 0:i?Ym(e,t):e,n=r.length-1,a;n>=0;n--)(a=r[n])&&(s=(i?a(e,t,s):a(s))||s);return i&&s&&Vm(e,t,s),s};let Ci=class extends _t{constructor(){super(...arguments),this.tRef=ue(),this.vRef=ue(),this.haRef=ue()}calculateE(r,e){return r*(6.105/100)*Math.exp(17.27*e/(237.7+e))}calculateTa(r,e,t){return r+.33*e-.7*t-4}firstUpdated(r){super.firstUpdated(r),this.tRef.value&&this.tRef.value.addEventListener("change",e=>{const t=e.target,i=parseFloat(t.value);isNaN(i)||(this.t=Math.min(100,Math.max(-275.4,i)))}),this.haRef.value&&this.haRef.value.addEventListener("change",e=>{const t=e.target,i=parseFloat(t.value);isNaN(i)||(this.ha=Math.min(100,Math.max(0,i)))}),this.vRef.value&&this.vRef.value.addEventListener("change",e=>{const t=e.target,i=parseFloat(t.value);isNaN(i)||(this.v=Math.max(0,i))})}updated(r){if(super.updated(r),this.t!==void 0&&this.ha!==void 0&&this.v!==void 0){const e=this.calculateE(this.ha,this.t),t=this.calculateTa(this.t,e,this.v);this.ta=t}this.t===void 0&&this.tRef.value&&(this.tRef.value.value=""),this.ha===void 0&&this.haRef.value&&(this.haRef.value.value=""),this.v===void 0&&this.vRef.value&&(this.vRef.value.value="")}renderNumberField(r,e,t,i,s,n,a,o,l){return x`
        ...
        `}renderResult(r,e){const t=r-e,i={diff:Math.abs(t).toFixed(2),t:e},s=t<0?L(E.youfeelcolder,i):L(E.youfeelwarmer,i),n=r.toFixed(2);return x`<main class="result">
            ...
            <div slot="bar" style="flex-grow: 4;">
                ...
                <thermal-dialog label=${L(E.info)}>
                    ...
                    <div slot="content">
                        ${Ht(L(E.apparenttemperaturehint,{href:"https://en.wikipedia.org/wiki/Wind_chill#Australian_apparent_temperature"}))}
                    </div>
                </thermal-dialog>
                ...
                ${this.renderNumberField(this.vRef,this.UUID+"aat_wind_speed",L(E.windspeed),"m/s2",this.v,0,void 0,.1)}
            ...
            <thermal-dialog label=${L(E.fileinfo)}>
                ...
                <div slot="content">
                    ...
                    <table>
                        ...
                        ${Ht(this.renderRow(L(E.thermalfilename),this.file.fileName))}

                        ${Ht(this.renderDownloadRow(L(E.thermalfileurl),this.file.thermalUrl,this.file.thermalUrl,L(E.thermalfiledownload)))}

                        ${this.file.visibleUrl?Ht(this.renderDownloadRow(L(E.visiblefileurl),this.file.visibleUrl,this.file.visibleUrl,L(E.visiblefiledownload))):j}

                        ${Ht(this.renderRow(L(E.time),tt.human(this.file.timestamp)))}

                        ${Ht(this.renderNumericalRow(L(E.duration),this.file.duration,0,"ms"))}

                        ${Ht(this.renderRow(L(E.resolution),`${this.file.width} x ${this.file.height}<small class="opaque">${this.file.pixels.length} pixels</small>`))}

                        ${Ht(this.renderNumericalRow(L(E.bytesize),this.file.bytesize,0))}
                        
                        ${Ht(this.renderNumericalRow(L(E.minimaltemperature),this.file.max,10,"°C"))}

                        ${Ht(this.renderNumericalRow(L(E.maximaltemperature),this.file.min,10,"°C"))}
                    ...
                    <h2>${L(E.filetype)}</h2>
                    <table>
                    ${Ht(this.renderRow(L(E.type),this.file.reader.parser.name))}
                    ${Ht(this.renderRow(L(E.description),this.file.reader.parser.description))}
