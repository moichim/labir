...
@customElement("thermal-histogram")
export class HistogramElement extends ElementInheritingRegistry {
    ...
    disconnectedCallback(): void {
        ...
        this.registry.histogram.removeListener( this.identificator );
    }
