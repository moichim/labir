...
//#region src/responseEntities.d.ts
/**
...
//#endregion
//#region src/authentication/Auth.d.ts
declare class Auth {
...
//#endregion
//#region src/entities/Entities.d.ts
...
//#endregion
//#region src/request/RequestFactory.d.ts
...
//#endregion
//#region src/routes/ResponseTypes.d.ts
...
//#endregion
//#region src/routes/Operation.d.ts
/**
...
//#endregion
//#region src/routes/get/GetConnect.d.ts
...
//#endregion
//#region src/routes/get/GetCurrentUserTree.d.ts
...
//#endregion
//#region src/routes/OperationWithPath.d.ts
/**
...
//#endregion
//#region src/routes/get/GetInfo.d.ts
...
//#endregion
//#region src/routes/get/GetFile.d.ts
...
//#endregion
//#region src/routes/OperationWithPathAndFilters.d.ts
/**
...
//#endregion
//#region src/routes/get/GetFiles.d.ts
...
//#endregion
//#region src/routes/get/GetGrid.d.ts
...
//#endregion
//#region src/routes/factories/GetRoutesFactory.d.ts
/**
...
//#endregion
//#region src/routes/post/CreateFolder.d.ts
type CreateDataType = {
  result: {
    slug?: string;
    name?: string;
...
//#endregion
//#region src/routes/OperationWithFile.d.ts
/**
 * A base operation that needs to have a path specified.
 * @package `@labirthermal/client`
 */
...
//#endregion
//#region src/routes/post/DeleteFile.d.ts
...
//#endregion
//#region src/routes/post/DeleteFolder.d.ts
...
//#endregion
//#region src/routes/post/FileAddComment.d.ts
...
//#endregion
//#region src/routes/post/FileClearComments.d.ts
...
//#endregion
//#region src/routes/post/FileDeleteComment.d.ts
...
//#endregion
//#region src/routes/post/FileUpdateComment.d.ts
...
//#endregion
//#region src/routes/post/Login.d.ts
 ...
 * @package `@labirthermal/client`
 */
declare class Login extends Operation<PostLoginDataType> {
  init(): this;
  setUser(user: string): this;
  setPassword(password: string): this;
  execute(): Promise<ApiResponseType<PostLoginDataType>>;
}
//#endregion
//#region src/routes/post/Logout.d.ts
...
//#endregion
//#region src/routes/post/MoveFolder.d.ts
...
//#endregion
//#region src/routes/post/UpdateFile.d.ts
...
//#endregion
//#region src/routes/post/UpdateFolder.d.ts
type PostUpdateFolderDataType = {
  result: {
    /** The new slug of the updated folder */slug?: string; /** The new name of the updated folder */
    name?: string; /** The new description of the updsated folder */
    description?: string; /** The old slug of the folder (in case it moved) */
    oldSlug?: string; /** The standard folder info */
    info: FolderInfo; /** Whether the folder itself renames on the disk */
    moved: boolean;
  };
};
/**
 ...
 * @package `@labirthermal/client`
 */
declare class UpdateFolder extends OperationWithPath<PostUpdateFolderDataType> {
...
//#endregion
//#region src/routes/post/UploadFile.d.ts
...
//#endregion
//#region src/routes/post/MoveFile.d.ts
...
//#endregion
//#region src/routes/factories/PostRoutesFactory.d.ts
/**
...
declare class PostRoutesFactory {
  ...
  logout(): Logout;
  createFolder(/** An obligatory path of the folder in which the new Folder shall be created */

  targetPath: string, /** Name of the new folder - will be webalised for the real folder name in the file system */
...
//#endregion
//#region src/routes/factories/Routes.d.ts
/**
...
//#endregion
export { type ApiResponseType, type BreadcrumbItem, type Comment, type FileInfo, type FolderInfo, type GetCurrentUserTreeDataType, type GetFilesDataType, type GetGridDataType, type GetInfoDataType, GridGrouping, type Identity, type PostLoginDataType, type PostUpdateFolderDataType, type ServerInfo, type TagDefinition, type TagInfo, type TreeItem, ApiClient as default };
