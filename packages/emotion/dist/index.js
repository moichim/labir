...
`,[]);return m("paletteDropdown",t),$("paletteDropdown",t),jsxRuntime.jsx(jsxRuntime.Fragment,{children:jsxRuntime.jsxs(react$2.Menu,{children:[jsxRuntime.jsx(react$2.MenuButton,{as:l,children:jsxRuntime.jsx(jsxRuntime.Fragment,{children:jsxRuntime.jsx(reactBridge.PaletteItem,{...r.palette})})}),jsxRuntime.jsx(react$2.MenuItems,{anchor:{to:"bottom",gap:"5px",offset:"0px",padding:"5px"},portal:!1,as:"nav",style:{background:"red"},className:"lrc__paletteDropdown__items lrc-dark lrc-app__root",children:Object.entries(r.availablePalettes).map(([o,a])=>jsxRuntime.jsx(react$2.MenuItem,{as:"div",onClick:()=>r.set(o),className:"lrc__paletteDropdown__item",children:jsxRuntime.jsx(reactBridge.PaletteItem,{...a})},o))})]})})};var R=({variant:r="primary",className:t,...o})=>(m("thermalUiInput",`
