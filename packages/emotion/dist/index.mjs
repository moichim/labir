import { useSingleFileRegistry, ThermalRegistryRange, ThermalInstance, useRangeButtonAuto, useRangeButtonFull, useThermalManagerPaletteDrive, PaletteItem, useHistogramResolutionInput, useOpacityInput } from '@labir/react-bridge';
...
`,[]);return m("paletteDropdown",t),$("paletteDropdown",t),jsx(Fragment,{children:jsxs(Menu,{children:[jsx(MenuButton,{as:l,children:jsx(Fragment,{children:jsx(PaletteItem,{...r.palette})})}),jsx(MenuItems,{anchor:{to:"bottom",gap:"5px",offset:"0px",padding:"5px"},portal:!1,as:"nav",style:{background:"red"},className:"lrc__paletteDropdown__items lrc-dark lrc-app__root",children:Object.entries(r.availablePalettes).map(([o,a])=>jsx(MenuItem,{as:"div",onClick:()=>r.set(o),className:"lrc__paletteDropdown__item",children:jsx(PaletteItem,{...a})},o))})]})})};var R=({variant:r="primary",className:t,...o})=>(m("thermalUiInput",`
