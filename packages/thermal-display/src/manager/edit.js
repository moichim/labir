...
import { useCallback, useEffect, useMemo, useState, createContext } from '@wordpress/element';
...
export default function Edit({ attributes, setAttributes }) {
	...
	useEffect( () => {
		...
		if ( slug === "default_slug" ) {
			setAttributes( { slug: "manager_" +ID } );
		}
			...
			<div style={{
				...
				<div {...blockProps} {...innerBlocksProps} >
					...
					<div style={{
						...
						<div>Thermal Manager</div>
						<div>Palette: {palette}</div>
					</div>

					<manager-provider ref={previewRef} palette={palette}>
