...
if ( ! function_exists( "thermal_display_register_assets" ) ) {
    ...
    function thermal_display_register_assets() {
        ...
        wp_register_style( 
            $styles_name, 
            "https://cdn.jsdelivr.net/npm/@labir/embed@1.2.53/dist/embed.min.css",
        ...
        wp_register_script( 
            $scripts_name_cjs, 
            "https://cdn.jsdelivr.net/npm/@labir/embed@1.2.53/dist/embed.min.js",
        ...
        wp_register_script( 
            $scripts_name_es, 
            "https://cdn.jsdelivr.net/npm/@labir/embed@1.2.53/+esm",
