...
var WasmApp = class {
  ...
  async init() {
    this.wasm = await WebAssembly.instantiate(bytes, importObject).then((res) => {
      return res.instance;
    });
  }
  add(a, b) {
  ...
  baseinfo(file) {
    ...
    return this.wasm.exports.baseInfo(file);
  }
};
